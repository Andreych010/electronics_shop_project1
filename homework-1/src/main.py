...
if __name__ == '__main__':
    ...
    print(f'Стоимость {item1.produkt} со скидкой в {Item.pay_rate}: {item1.price} ')  # Стоимость товара со скидкой 8000.0
    print(f'Стоимость {item2.produkt} ,без скидки: {item2.price}')  # Стоимость товара без скидки 20000
